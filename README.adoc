...
| 1.x            | 4.2.x to latest | 11
|===

The *Java version* column is the bytecode level of the latest release of each line, which sets the minimum runtime able to load the artifact — APIM runs on Java 21 from 4.7 onwards. The top line is not released yet: it is the one this change prepares.
